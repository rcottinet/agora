...
export default function JoinGame({ code }: { code: string }) {
  ...
  return (
    <>
      <Head title="Rejoindre la bataille" />
          ...
          <CardContent>
            <form onSubmit={submit} className="space-y-4">
              ...
              <Button type="submit" className="w-full" disabled={processing}>
                ...
                {processing ? 'Connexion...' : 'Rejoindre la bataille'}
              </Button>
            </form>
          </CardContent>
        </Card>
